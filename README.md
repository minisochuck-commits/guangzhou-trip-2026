...
> **本轮（科技就在身边 + 口吻纠错 + 房东视角商圈 + 广州区域负责人）待 owner 验收。**
> 新增「科技就在身边」六项（无人出租车、载人无人机、送餐机器人、无人机送外卖、无现金、
> 电动出租车），配图 5 张；商圈一节改为给商场方看；「中国区域负责人」改为「广州区域负责人」。
>
...
> 路线现为：花城广场（必去）· 登广州塔 · 珠江夜游 · 天河路太古汇 · 沙面。
>
> **本轮（体量展示 + 食在广州）待 owner 验收。** owner 说明了目的：让埃及同事看到中国
> 有多强大。指南前两块现在是「广州与你们」「这座城有多大」（八格 2025 年官方数字），
> 随后「你们住的这块地」（琶洲）、「食在广州」（九道菜）。数字来源见页内。
>
> **本轮（吃住行玩 + 个人链接 + 中国风视觉）待 owner 验收。**
> 页面的重点是**让客人在广州吃好住好行得顺玩得好**，不是行程管控，也不是业务安排。
> 新增「礼拜与清真餐」一节（三座清真寺 + 一家清真老字号 + 位置关系）、
> 出发前的「天气与穿什么」、四句打车问价的中文；
> 每人一条链接 `?p=<人>&lang=<语言>`，另有 `?p=all` 给中国同事统筹；
> 视觉改成宣纸底 + 朱红印章 + 宋体标题 + 回纹木棉。
> 表格结构、合并规则、筛选与日期跳转一律没动。详见 `DESIGN_NOTES.md` 开头那节。
